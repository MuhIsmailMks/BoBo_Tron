...
// meme maker 
// choise button 
const choiseButtons = document.querySelectorAll('.choiseBtnContainer button'); 
                ...
                <!-- left -->
                 <div class="left">
                    ...
                    <div class="indexTop cursor-pointer w-[70%] relative">
                        <img src="./static/icons/indexTop.svg" alt="" class="w-full h-auto object-contain">
                    </div>
    
                    <div class="indexBottom cursor-pointer w-[70%] relative">
                        <img src="./static/icons/indexBottom.svg" alt="" class="w-full h-auto object-contain">
                    </div>
    
                    <div class="mirrorMode cursor-pointer w-[70%] relative">
                        <img src="./static/icons/mirror.svg" alt="" class="w-full h-auto object-contain ">
                    </div>
    
                    <div class="mirrorTopMode cursor-pointer w-[70%] relative">
                        <img src="./static/icons/mirror.svg" alt="" class="w-full h-auto object-contain rotate-[90deg]">
                    </div>
    
                    <div class="deleteBtn cursor-pointer w-[70%] relative">
                        <img src="./static/icons/deleteIcon.svg" alt="" class="w-full h-auto object-contain">
                    </div>
                ...
                <!-- right -->
                 <div class="right-[0%] absolute h-full w-[25%] ">
                    ...
                    <div class="rotate rotateResizeElement rounded-lg  top-0">
                        <img src="./static/icons/rotate.svg" alt="" class="w-[70%] h-auto object-contain">
                    </div>
    
                    <div class="resize rotateResizeElement rounded-lg  bottom-0">
                        <img src="./static/icons/resize.svg" alt="" class="w-[70%] h-auto object-contain mirror_image">
                    </div>
